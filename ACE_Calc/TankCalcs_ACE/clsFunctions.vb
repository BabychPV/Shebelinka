...
Public Class clsFunctions
  ...
  ByRef value As String) As Boolean
    ...
    Public Shared Function LoadValueFromACEPoint(ByVal ptACE As PIACEPoint, ByVal aceClass As PIACENetClassModule, ByRef dblValue As Double) As Boolean
        ...
        Catch ex As Exception
            PIACEBIFunctions.LogPIACEMessage(MessageLevel.mlErrors, "ERROR. can't check subst. " & ptACE.Tag, aceClass.Name)
        End Try
    ...
    Public Shared Function InRepair(ByVal ptACE As PIACEPoint) As Boolean
        Try
            If ptACE.DigState(ptACE.Value).Code = 1 Then Return True
        Catch ex As Exception
            Return False
        End Try
    End Function
