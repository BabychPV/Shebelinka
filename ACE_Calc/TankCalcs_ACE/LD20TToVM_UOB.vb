...
Public Class LD20TToVM_UOB
    ...
    Public Overrides Sub ACECalculations()
        ...
        'Max level of Calibration Table sub current value 24_12_2020 Babych
        Try
            dblNewLevel = dblLevelMax - dblLevel
        ...
        If clsFunctions.CalcForTable(dblNewLevel, calTable, Me, "Level", "Volume total", dblVolume) = False Then
            CalcFailed()
            Exit Sub
        End If
    ...
    Protected Overrides Sub ModuleDependentInitialization()
        ...
        If clsFunctions.LoadValueFromProperty(pmRoot, c_LevelMax, Me, dblLevelMax) = False Then dblLevelMax = 0
        'If clsFunctions.CalcForTable(dblLevelMax, calTable, Me, c_LevelMax, c_VolumeMax, dblVolumeMax) = False Then dblVolumeMax = 0
