...
Public Class LD20TToVM
	...
	' Lygis                                   Lygis
	' Masл maksimali                          Mas__maksimali
	' Masл Viso                               Mas__Viso
	' Naudinga Masл                           Naudinga_Mas_
	' Naudingas Tыris                         Naudingas_T_ris
	' Nepaimamas likutis                      Nepaimamas_likutis
	' Tankis20                                Tankis20
	' TankState                               TankState
	' Temperatыra                             Temperat_ra
    ' Tыris                                   T_ris
    ...
    Protected Overrides Sub InitializePIACEPoints()
        ...
        'TankState = GetPIACEPoint("TankState")
