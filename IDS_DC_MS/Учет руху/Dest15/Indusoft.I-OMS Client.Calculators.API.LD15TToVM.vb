...
Public Class LD15TToVM : Implements ICalculator
    ...
    Public Sub Calculate(ByVal currentTime As Date, ByRef mTank As OMSClient.Common.clsMyNewTank, ByVal userPref As System.Collections.Hashtable) Implements OMSClient.Common.ICalculator.Calculate
        ...
        Dim mAliasMassDead, mAliasDensity15, mAliasTankState As clsAlias

        Dim dblLevel, dblVolume, dblVolumeDead, dblTemp, dblAmbTemp, dblD15, dblD, dblMTotal, dblMDead, dblMMax As Double
        Dim dbl_p60, dbl_T, dbl_T15F, dbl_CTPL60, dbl_CTPL, dbl_CTSh, dblLTEC As Double
        ...
        mAliasDensity15 = mTank.aliases(My.Resources.Density15)
        ...
        If mAliasAmbTemperature Is Nothing Then
            ...
            Exit Sub
        End If
        If mAliasDensity15 Is Nothing Then
            MsgBox("Can't find Alias Density15")
            Exit Sub
        End If
        ...
        If IsNumeric(mAliasLevel.valueForCalc) And IsNumeric(mAliasAmbTemperature.valueForCalc) _
            And IsNumeric(mAliasTemperature.valueForCalc) And IsNumeric(mAliasDensity15.valueForCalc) Then

            dblLevel = mAliasLevel.valueForCalc
            dblD15 = mAliasDensity15.valueForCalc
